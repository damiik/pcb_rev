...
final class KiCadSchematicParser {
  ...
  static ParseResult<KiCadSchematic> _parseSchematicFromSExprs(List<SExpr> sexprs) {
    try {
      final schematicExpr = sexprs.firstWhere(
            (expr) => expr is SList && expr.elements.isNotEmpty && (expr.elements.first as SAtom).value == 'kicad_sch',
        orElse: () => throw Exception('No kicad_sch root element found'),
      ) as SList;
  ...
  static KiCadSchematic _parseSchematicExpr(SList expr) {
    ...
    for (final element in expr.elements.skip(1)) {
      switch (element) {
        case SList(elements: [SAtom(value: 'version'), SAtom(value: final v), ...]):
          version = v;
        case SList(elements: [SAtom(value: 'generator'), SAtom(value: final g), ...]):
          generator = g;
        case SList(elements: [SAtom(value: 'uuid'), SAtom(value: final u), ...]):
          uuid = u;
        case SList(elements: [SAtom(value: 'lib_symbols'), ...final libElements]):
          library = KiCadParser.parseLibraryExpr(SList([SAtom('kicad_symbol_lib'), ...libElements]));
        ...
        case SList(elements: [SAtom(value: 'wire'), ...final wireElements]):
          ...
          break;
        case SList(elements: [SAtom(value: 'junction'), ...final junctionElements]):
  ...
  static SymbolInstance _parseSymbolInstance(List<SExpr> elements) {
    ...
    for (final element in elements) {
       switch (element) {
        case SList(elements: [SAtom(value: 'lib_id'), SAtom(value: final id), ...]):
          libId = id;
        case SList(elements: [SAtom(value: 'at'), SAtom(value: final x), SAtom(value: final y), SAtom(value: final angle), ...]):
        ...
        case SList(elements: [SAtom(value: 'unit'), SAtom(value: final u), ...]):
          unit = int.parse(u);
        case SList(elements: [SAtom(value: 'in_bom'), SAtom(value: final v), ...]):
          inBom = v == 'yes';
        case SList(elements: [SAtom(value: 'on_board'), SAtom(value: final v), ...]):
          onBoard = v == 'yes';
      ...
      switch (element) {
        case SList(elements: [SAtom(value: 'pts'), ...final ptElements]):
          for (final ptExpr in ptElements) {
            if (ptExpr case SList(elements: [SAtom(value: 'xy'), SAtom(value: final x), SAtom(value: final y)])) {
        ...
        case SList(elements: [
            SAtom(value: 'stroke'),
            SList(elements: [SAtom(value: 'width'), SAtom(value: final w), ...]),
            ...
          ]):
  ...
  static Junction _parseJunction(List<SExpr> elements) {
    ...
    for (final element in elements) {
      switch (element) {
        case SList(elements: [SAtom(value: 'at'), SAtom(value: final x), SAtom(value: final y), ...]):
          at = Position(double.parse(x), double.parse(y));
        case SList(elements: [SAtom(value: 'uuid'), SAtom(value: final u), ...]):
          uuid = u;
        case SList(elements: [SAtom(value: 'diameter'), SAtom(value: final d), ...]):
