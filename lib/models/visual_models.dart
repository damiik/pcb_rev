...
Map<String, dynamic> symbolToJson(Symbol s) => {
  'id': s.id,
  'logicalComponentId': s.logicalComponentId,
  'position': positionToJson(s.position),
  'rotation': s.rotation,
};
Symbol symbolFromJson(Map<String, dynamic> json) => (
...
Map<String, dynamic> schematicViewToJson(SchematicView s) => {
  'symbols': s.symbols.map((k, v) => MapEntry(k, symbolToJson(v))),
  'wires': s.wires.map((k, v) => MapEntry(k, wireToJson(v))),
};

SchematicView schematicViewFromJson(Map<String, dynamic> json) => (
  symbols: (json['symbols'] as Map<String, dynamic>).map((k, v) => MapEntry(k, symbolFromJson(v as Map<String, dynamic>))),
